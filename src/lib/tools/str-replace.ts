...
export const buildStrReplaceTool = (fileSystem: VirtualFileSystem) => {
  return tool({
    description:
      "Create, view, and edit files. Use 'create' to make a new file, 'str_replace' to replace an exact string match within a file, 'insert' to insert text at a specific line, and 'view' to read a file's contents.",
